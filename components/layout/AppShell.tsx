...
import { Home, UtensilsCrossed, Link2, Megaphone, Settings, Search, LifeBuoy, Radar, ShieldCheck, UsersRound } from "lucide-react";
...
const baseNavigation: AppNavItem[] = [
    ...
    { label: "Radar do Pernoite", href: "/radar-pernoite", view: "radar-pernoite", icon: Radar },
